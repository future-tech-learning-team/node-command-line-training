...
//test-cli fileOperation add  --fileName=b.md --content=传入的内容
try{
    let commandFun
    if(subCommand==='fileOperation'){
        commandFun = require('jae-dynamic-cli-demo');
        commandFun = commandFun.default || commandFun;
        console.log(commandFun);
        commandFun({
            ...argvs,
            _:[argvs._[1]]
        });
